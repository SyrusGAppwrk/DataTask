...
function ProjectManger() {
 ...
 //----------------- Insert Data PC
 const handlePmdata = async (values, resetForm) => {
 ...
 //----------------- Update Data
 const handlePmdataupdate = async (values, resetForm) => {
 ...
 return (
     <>
         <div className='container mt-3'>
             <div className="card">
                 <div className="card-header bg-warning"><span style={{ fontWeight: "bold" }}>Project Manager</span>
                 ...
                 <Modal.Body>
                     <Formik
                         ...
                         onSubmit={(values, { resetForm }) => {
                             isPost ? handlePmdata(values, resetForm) : handlePmdataupdate(values, resetForm);
                         }}
